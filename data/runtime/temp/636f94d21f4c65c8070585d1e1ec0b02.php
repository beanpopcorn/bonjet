...
<head> 
    ...
    <?php  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/css/basic.css","","",""); echo $__VALUE__;  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/css/swiper.min.css","","",""); echo $__VALUE__;  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/js/jquery.min.js","","",""); echo $__VALUE__;  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/js/ft-carousel.min.js","","",""); echo $__VALUE__; ?>
 </head> 
    ...
    <!-- <div class="best">
        ...
        <div class="contact-page">
            <div class="google-map">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3691.401370304706!2d114.17658101534586!3d22.300655248516478!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x340400ef4296cd55%3A0xe8f1cd2b51abccdc!2z5bCW5p2x56eR5a246aSo6YGTMTTomZ_mlrDmlofljY7kuK3lv4NC5bqn!5e0!3m2!1szh-CN!2shk!4v1570622084668!5m2!1szh-CN!2shk" width="100%" height="100%" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
            </div>
            <div class="ct">
                <div class="c-title">BONJET INTERNATIONAL LIMITED</div>
                <div class="c-address">
                    <p>Office Address:</p>
                    <p><?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_attr_21"); echo $__VALUE__; ?></p>
                </div>
                <div class="c-box">
                    <span class="c-box-tel">Tel : <?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_attr_15"); echo $__VALUE__; ?></span>
                    <span class="c-box-email">Email : <?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_attr_17"); echo $__VALUE__; ?></span>
                    <span class="c-box-fax">Fax : <?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_attr_19"); echo $__VALUE__; ?></span>
                </div>
            </div>
            <div class="clear"></div>
