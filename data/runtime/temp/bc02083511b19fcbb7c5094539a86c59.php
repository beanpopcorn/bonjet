<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:44:"./application/admin/template/index\index.htm";i:1577072959;s:66:"D:\wamp64\www\bonjet\application\admin\template\public\menubox.htm";i:1575083809;s:63:"D:\wamp64\www\bonjet\application\admin\template\public\left.htm";i:1575083809;}*/ ?>
<!doctype html>
<html>
<head>
...
<link rel="shortcut icon" type="image/x-icon" href="/bonjet/favicon.ico" media="screen"/>
...
<script type="text/javascript" src="/bonjet/public/static/admin/js/jquery.bgColorSelector.js"></script>
<script type="text/javascript" src="/bonjet/public/static/admin/js/admincp.js?v=<?php echo $version; ?>"></script>
<script type="text/javascript" src="/bonjet/public/static/admin/js/jquery.validation.min.js"></script>

<!-- <script type="text/javascript" src="/bonjet/public/plugins/layer/layer.js"></script> -->
<script type="text/javascript" src="/bonjet/public/plugins/layer-v3.1.0/layer.js?v=<?php echo $version; ?>"></script>
<script type="text/javascript" src="/bonjet/public/static/admin/js/dialog/dialog.js?v=<?php echo $version; ?>" id="dialog_js"></script>
...
<div class="eycms_cont_left hidden-xs">
    <dl class="eylogo">
        ...
        <a href="<?php echo \think\Request::instance()->url(); ?>"><img id="web_adminlogo" src="/bonjet/public/static/admin/images/logo_ey.png?v=<?php echo time(); ?>" alt="点击刷新" title="点击刷新"></a>
        <?php else: ?>
        <a href="<?php echo \think\Request::instance()->url(); ?>"><img id="web_adminlogo" src="/bonjet/public/static/admin/images/logo.png?v=<?php echo time(); ?>" alt="点击刷新" title="点击刷新"></a>
        <?php endif; ?>
    </dl>
