...
<div class="top"></div>
    ...
    <!-- <div class="best">
        ...
        <div class="company-container">
            <div class="company-header">
                <div class="company-title"><?php echo $eyou['field']['title']; ?></div>
                        ...
                        <div class="book-wrapper">
                            <div class="book-box">
                                ...
                                <div class="book-content">
                                    <?php echo $eyou['field']['description']; ?>
                                </div>
                            </div>
                            <div class="book-pic">
                                <img src="<?php echo $eyou['field']['litpic']; ?>"/>
                            </div>
                        </div>
                    </div>
                    <?php if(empty($eyou['field']['Specifications']) || (($eyou['field']['Specifications'] instanceof \think\Collection || $eyou['field']['Specifications'] instanceof \think\Paginator ) && $eyou['field']['Specifications']->isEmpty())): ?>
                    <div class="book-cc"></div>
                    <?php else: ?>
                    <div class="book-cc">
                        <div class="book-title">
                            Specifications
                        ...
                        <div class="book-spec">
                            <?php echo $eyou['field']['Specifications']; ?>
                        </div>                     
                    </div>
                    <?php endif; ?>
                    <div class="book-cc">
                        ...
                        <div class="book-shipment">
                            <?php echo $eyou['field']['Shipment']; ?>
                        </div>
                    </div>
                    <div class="book-cc">
                        <div class="book-title">
                        ...
                        <div class="book-orgin">
                            <?php echo $eyou['field']['Origin']; ?>
                        </div>
                    </div>
                    <div class="book-cc">
                        <div class="book-list">
  ...
  'row' => '8',
                                ...
                                <li>
                                    ...
                                    <div class="book-name"><?php echo $field['title']; ?></div>
