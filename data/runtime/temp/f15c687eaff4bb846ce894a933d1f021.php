            ...
            <div class="company-article">
                ...
                <div class="seasonal">
                    <div class="leaflet-wrapper">
                        <div class="leaflet-left">Bonjet International Ltd. is famous for manufacturing all kinds custom made souvenir metal products, which include bottle openers; cuff links, lapel pins; key chains; coins; medals; military badges; garment buttons; car emblems; metallic coasters; golf accessories and seasonal ornaments...etc. The metals applied for production are ranging from brass, stainless steel, iron, aluminum to pewter (tin and lead alloy) and zinc alloy, and the methods to form the images and shapes are stamping, photo etching, screen printing, offset printing, spin casting and die casting.</div>
                        <div class="leaflet-right">
                            <div class="leaflet-pic">
                                <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/images/leaflet.jpg">
                            </div>
                            <div class="leaflet-catname"><?php echo $eyou['field']['typename']; ?></div>
                        </div>
                    </div>
                    <div class="seasonal-box">
                        <!-- <div class="seasonal-switch">
                            <span class="seasonal-cc">
                                <a href="" class="seasonal-cc-prev"></a>
                                <a href="" class="seasonal-cc-next"></a>
                            </span>
                        </div> -->
                        <div class="seasonal-list">
                            <ul>
                                <?php  $typeid = "";  if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  $param = array(      "typeid"=> $typeid,      "notypeid"=> "",      "flag"=> "",      "noflag"=> "",      "channel"=> "", ); $tagList = new \think\template\taglib\eyou\TagList; $_result_tmp = $tagList->getList($param, 8, "now", "", "desc", "on");if(is_array($_result_tmp) || $_result_tmp instanceof \think\Collection || $_result_tmp instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = $_result = $_result_tmp["list"]; $__PAGES__ = $_result_tmp["pages"];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $aid = $field["aid"];$field["title"] = text_msubstr($field["title"], 0, 30, false);$field["seo_description"] = text_msubstr($field["seo_description"], 0, 160, true);$i= intval($key) + 1;$mod = ($i % 2 ); ?>
                                <li>
                                    <div class="seasonal-pic">
                                        <a href="<?php echo $field['litpic']; ?>" class="example1"><img src="<?php echo $field['litpic']; ?>"></a>
                                    </div>
                                    <div class="seasonal-title"><?php echo $field['title']; ?></div>
                                </li>
                                <?php ++$e; $aid = 0; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $field = []; ?> 
                            </ul>
                        </div>
