    ...
    <!-- <div class="best">
        ...
        <div class="company-container">
            ...
            <div class="company-article">
                <div class="factory-note"><?php  $tagField = new \think\template\taglib\eyou\TagField; $__VALUE__ = $tagField->getField("factorytour", "130"); echo $__VALUE__; ?></div>
                <div class="factory-piclist">
                    <ul>
                        <?php  $aid = "130"; $tagArcview = new \think\template\taglib\eyou\TagArcview; $_result = $tagArcview->getArcview($aid, "factory1",""); if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator):  $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: $eyoav = $__LIST__; $tagDiyfield = new \think\template\taglib\eyou\TagDiyfield;$eyoav['factory1'] = $tagDiyfield->getDiyfield($eyoav['factory1'], "imgs");if(is_array($eyoav['factory1']) || $eyoav['factory1'] instanceof \think\Collection || $eyoav['factory1'] instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = $eyoav['factory1'];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$factory1): $i= intval($key) + 1;$mod = ($i % 2 ); ?>
                                <li>
                                    <a href="<?php echo $factory1['image_url']; ?>" class="example1"><img src='<?php echo $factory1['image_url']; ?>' /></a>
                                </li>
                            <?php ++$e; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $factory1 = []; endif; else: echo htmlspecialchars_decode("");endif; unset($aid); $eyoav = []; ?>
                    </ul>
                </div>
                <div class="factory-imgbox">
                    <ul>
                        <li><iframe width="100%" height="100%" src="https://www.youtube.com/embed/<?php  $tagField = new \think\template\taglib\eyou\TagField; $__VALUE__ = $tagField->getField("fvideo1", "130"); echo $__VALUE__; ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe></li>
                        <li><iframe width="100%" height="100%" src="https://www.youtube.com/embed/<?php  $tagField = new \think\template\taglib\eyou\TagField; $__VALUE__ = $tagField->getField("fvideo2", "130"); echo $__VALUE__; ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe></li>
                        <li><iframe width="100%" height="100%" src="https://www.youtube.com/embed/<?php  $tagField = new \think\template\taglib\eyou\TagField; $__VALUE__ = $tagField->getField("fvideo3", "130"); echo $__VALUE__; ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe></li>
                    </ul>
                </div>
            </div>
            <div class="clear"></div>
...
<![endif]-->
    ...
    <?php  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/js/jquery.js","","",""); echo $__VALUE__;  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/js/jquery.imgbox.pack.js","","",""); echo $__VALUE__; ?>
    <script type="text/javascript">
        $(function(){
            $(".example1").imgbox({
                'speedIn'       : 0,
