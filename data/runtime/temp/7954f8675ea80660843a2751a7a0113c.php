    ...
    <!-- <div class="best">
        ...
        <div class="company-container">
            ...
            <div class="company-article">
                <!-- Privacy Policy -->
                <div class="cp-policy">
                    <?php  $tagField = new \think\template\taglib\eyou\TagField; $__VALUE__ = $tagField->getField("privacy", "124"); echo $__VALUE__; ?>
                </div>
            </div>
            <div class="clear"></div>
