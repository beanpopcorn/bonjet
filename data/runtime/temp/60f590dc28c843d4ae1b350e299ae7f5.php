<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:46:"./application/admin/template/arctype\index.htm";i:1575083801;s:65:"D:\wamp64\www\bonjet\application\admin\template\public\layout.htm";i:1575083809;s:65:"D:\wamp64\www\bonjet\application\admin\template\public\footer.htm";i:1575083809;}*/ ?>
<!doctype html>
<html>
<head>
...
<link href="/bonjet/public/plugins/layui/css/layui.css?v=<?php echo $version; ?>" rel="stylesheet" type="text/css">
<link href="/bonjet/public/static/admin/css/main.css?v=<?php echo $version; ?>" rel="stylesheet" type="text/css">
<link href="/bonjet/public/static/admin/css/page.css?v=<?php echo $version; ?>" rel="stylesheet" type="text/css">
...
<link href="/bonjet/public/static/admin/js/jquery-ui/jquery-ui.min.css" rel="stylesheet" type="text/css"/>
<link href="/bonjet/public/static/admin/js/perfect-scrollbar.min.css" rel="stylesheet" type="text/css"/>
<style type="text/css">html, body { overflow: visible;}</style>
<script type="text/javascript" src="/bonjet/public/static/admin/js/jquery.js"></script>
<script type="text/javascript" src="/bonjet/public/static/admin/js/jquery-ui/jquery-ui.min.js"></script>
<script type="text/javascript" src="/bonjet/public/plugins/layer-v3.1.0/layer.js"></script>
<script type="text/javascript" src="/bonjet/public/static/admin/js/jquery.cookie.js"></script>
<script type="text/javascript" src="/bonjet/public/static/admin/js/admin.js?v=<?php echo $version; ?>"></script>
<script type="text/javascript" src="/bonjet/public/static/admin/js/jquery.validation.min.js"></script>
<script type="text/javascript" src="/bonjet/public/static/admin/js/common.js?v=<?php echo $version; ?>"></script>
<script type="text/javascript" src="/bonjet/public/static/admin/js/perfect-scrollbar.min.js"></script>
<script type="text/javascript" src="/bonjet/public/static/admin/js/jquery.mousewheel.js"></script>
<script type="text/javascript" src="/bonjet/public/plugins/layui/layui.js"></script>
<script src="/bonjet/public/static/admin/js/myFormValidate.js"></script>
<script src="/bonjet/public/static/admin/js/myAjax2.js?v=<?php echo $version; ?>"></script>
              ...
              <tr>
                ...
                <th axis="col3" class="">
                  <div class="sundefined" style="padding-left: 15px">
                    <img src="/bonjet/public/static/admin/images/tv-expandable.gif" id="all_treeclicked" title="展开所有子栏目" style="float: none;" data-status="close" onClick="treeClicked(this,'all',0);">
                    栏目名称
                  </div>
                </th>
            ...
            <tr nctype="0" <?php if($vo['parent_id'] > 0): ?> style="display:none;"<?php endif; ?> class="parent_id_<?php echo $vo['parent_id']; ?>" data-level="<?php echo $vo['level']; ?>" data-id="<?php echo $vo['id']; ?>">
              ...
              <td class="typename" style="width: 100%">
                <div>
                  ...
                  <img src="/bonjet/public/static/admin/images/tv-expandable.gif" style="float: none;" fieldid="2" status="open" nc_type="flex" onClick="treeClicked(this,<?php echo $vo['id']; ?>,0);" class="has_children">
                  <?php else: ?>
                  <img src="/bonjet/public/static/admin/images/tv-collapsable-last.gif" style="float: none;" fieldid="2" status="open" nc_type="flex">
  ...
  <script type="text/javascript">
    ...
    function treeClicked(obj,id,reload){
        if (id == 'all') {
          ...
          if (status == 'close') {
            $('tr[class^=parent_id_]').show().find('img').attr('src', '/bonjet/public/static/admin/images/tv-collapsable-last.gif');
            $(obj).attr('data-status', 'open').attr('title','关闭所有子栏目').attr('src','/bonjet/public/static/admin/images/tv-collapsable-last.gif');
          } else {
            ...
            $(obj).attr('data-status', 'close').attr('title','展开所有子栏目').attr('src','/bonjet/public/static/admin/images/tv-expandable.gif');
          }
         ...
         if(src == '/bonjet/public/static/admin/images/tv-expandable.gif')
         {
             // $("#treet1 tr").removeClass('tb_child');
             // $(".parent_id_"+id).addClass('tb_child');
             $(".parent_id_"+id).show();
             $(obj).attr('src','/bonjet/public/static/admin/images/tv-collapsable-last.gif');
             var status = 'close';
         }else{
             $(obj).attr('src','/bonjet/public/static/admin/images/tv-expandable.gif');     
             var status = 'open';      
              ...
              for (i = 0; i < tbl.rows.length; i++)
              {
                  ...
                  else
                  {
                      if (fnd == true)
                      {
                          ...
                          {
                              $(row).hide();        
                              $(row).find('img.has_children').attr('src','/bonjet/public/static/admin/images/tv-expandable.gif');
                          }
                          else
                          {
                              fnd = false;
